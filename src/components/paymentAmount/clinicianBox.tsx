...
interface ClinicianBoxProps {
    doctorFee?: string;
    doctorSecondFee?: string;
    doctorAfterFee?: string;
}

export const ClinicianBox = ({doctorFee, doctorSecondFee, doctorAfterFee}: ClinicianBoxProps) => {
    return (
        <ClinicianBoxWrapper>
                            <ClinicianTitleBox>
